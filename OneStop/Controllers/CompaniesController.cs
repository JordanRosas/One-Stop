...
namespace OneStop.Controllers
{
    public class CompaniesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,CreatorId,CompanyName,CompanyWebsite,Address,CityState")] Company company)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,CreatorId,CompanyName,CompanyWebsite,Address,CityState")] Company company)
        {
            if (id != company.Id)
            {
                return NotFound();
